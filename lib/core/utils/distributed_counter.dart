...
class DistributedCounter {
  ...
  static Future<void> increment(DocumentReference docRef, String counterName, {int value = 1}) async {
  ...
  static void incrementInBatch(WriteBatch batch, DocumentReference docRef, String counterName, {int value = 1}) {
    final shardId = Random().nextInt(numShards).toString();
    final shardRef = docRef.collection('${counterName}_shards').doc(shardId);
    batch.set(shardRef, {
      'count': FieldValue.increment(value),
