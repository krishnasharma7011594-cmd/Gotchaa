            ...
            child: _isExpanded 
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _buildStoryItem(context, dataIndex, widget.isExplore);
                  },
                )
            ...
            Stack(
              ...
              children: [
                ...
                CircleAvatar(
                  ...
                  backgroundImage: profileAsync.hasValue && profileAsync.value?.photoUrl.isNotEmpty == true
                      ? CachedNetworkImageProvider(profileAsync.value!.photoUrl)
                      : null,
                  child: (!profileAsync.hasValue || profileAsync.value?.photoUrl.isEmpty == true)
                      ? Icon(Icons.person_rounded, color: context.iconSecondary, size: 28)
                      : null,
                ),
