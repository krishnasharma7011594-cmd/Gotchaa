...
class NationData {
  ...
  String get continentColorHex {
    switch (continent) {
      case 'Asia':      return '#FFF3E0'; // orange tint
      case 'Europe':    return '#E3F2FD'; // blue tint
      case 'Americas':  return '#E8F5E9'; // green tint
      case 'Africa':    return '#FFFDE7'; // yellow tint
      case 'Oceania':   return '#E0F2F1'; // teal tint
      case 'Antarctica':return '#F5F5F5'; // white tint
  ...
  @override
  String toString() => 'NationData($flagAndName, via=$detectedVia, confidence=$confidence)';
}
