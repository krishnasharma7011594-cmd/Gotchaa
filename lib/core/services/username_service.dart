...
class UsernameService {
  ...
  Future<List<String>> generateSuggestions(String baseName) async {
    final cleanBase =
        baseName.replaceAll(RegExp('[^a-zA-Z0-9_]'), '').toLowerCase();
    final shortBase =
        cleanBase.length > 15 ? cleanBase.substring(0, 15) : cleanBase;
  ...
  Future<bool> updateUsername(
    ...
    if (data.containsKey('lastUsernameUpdate') &&
        data['lastUsernameUpdate'] != null) {
