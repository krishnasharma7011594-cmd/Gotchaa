...
class TextDirectionHelper {
  ...
  static EdgeInsetsDirectional symmetric({double horizontal = 0.0, double vertical = 0.0}) => EdgeInsetsDirectional.symmetric(horizontal: horizontal, vertical: vertical);
