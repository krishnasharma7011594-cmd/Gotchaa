...
final isContentLikedProvider =
    StreamProvider.family<bool, ({String contentId, String uid, String contentType, String? parentId})>((ref, args) => ref
      .watch(socialRepositoryProvider)
      .isLikedStream(
...
final isPostBookmarkedProvider =
    StreamProvider.family<bool, ({String postId, String uid})>((ref, args) => ref
      .watch(socialRepositoryProvider)
      .isBookmarkedStream(postId: args.postId, uid: args.uid));

final postCommentsLimitProvider = StateProvider.family<int, String>((ref, postId) => 20);
