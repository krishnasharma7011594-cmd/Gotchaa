...
class BackupPhraseScreen extends StatefulWidget {
  const BackupPhraseScreen(
      {required this.uid, required this.onComplete, super.key});
  final String uid;
                ...
                Expanded(
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) =>
                        _buildWordTile(index + 1, _words[index]),
                  ),
                ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: _isConfirmed
                        ? () async {
                            await _service.deriveIdentityKey(
                                _mnemonic, widget.uid);
                            widget.onComplete();
                          }
                        : null,
          ...
          children: [
            Text(
              ...
              style: GoogleFonts.jetBrainsMono(
                  color: AppColors.electricBlue, fontSize: 14),
            ),
