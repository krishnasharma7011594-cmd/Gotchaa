...
class PrivacyListsScreen extends ConsumerWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            _listTile(
              ...
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => const GhostListScreen()),
              ),
            ),
              ...
              children: [
                ...
                TextButton.icon(
                  onPressed: () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const EditCustomListScreen()),
                  ),
                  icon: const Icon(Icons.add_rounded, size: 20, color: AppColors.electricBlue),
                  label: Text(
                    'Create',
                    style: GoogleFonts.outfit(
            ...
            if (userProfile?.customPrivacyLists.isEmpty ?? true)
              ...
              ...userProfile!.customPrivacyLists.map((list) => _listTile(
                ...
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => EditCustomListScreen(list: list)),
                ),
              )),
          ],
        ),
  ...
  Widget _emptyState(bool isDark) => Container(
      ...
      child: Center(
        child: Column(
          children: [
            Icon(Icons.list_rounded, size: 48, color: Colors.grey.withValues(alpha: 0.3)),
