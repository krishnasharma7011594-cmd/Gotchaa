...
class CabTool extends BroTool {
  ...
  Map<String, dynamic> get parameters => {
        'destination':
            'The destination address or landmark (e.g., Cyber Hub, New Delhi)',
  ...
  Future<Map<String, dynamic>> execute(Map<String, dynamic> arguments) async {
    ...
    final provider =
        arguments['suggested_provider']?.toString().toLowerCase() ?? 'uber';
    ...
    if (await canLaunchUrl(Uri.parse(url))) {
      ...
      return {
        ...
        'action_url': url,
        'message':
            'I have prepared an $provider to $destination. Ready for your confirmation.',
      };
    } else {
      ...
      return {
        'status': 'error',
        'message':
            'I couldn\'t find the $provider app on your device. Would you like me to search for alternatives?',
      };
    }
  }
}
