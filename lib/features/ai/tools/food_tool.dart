...
class FoodTool extends BroTool {
  ...
  @override
  bool get requiresBiometrics => false; // Initial search doesn't need biometrics
  ...
  Future<Map<String, dynamic>> execute(Map<String, dynamic> arguments) async {
    ...
    final results = [
      {'name': 'Leo\'s Artisan Pizza', 'rating': 4.8, 'avg_time': '25 mins', 'popular': 'Pepperoni Pizza'},
      {'name': 'EVOO Eatery', 'rating': 4.6, 'avg_time': '40 mins', 'popular': 'Margherita'},
    ];
    ...
    return {
      ...
      'message': 'I found some top-rated places for $craving. Leo\'s is highly rated and the fastest right now.',
    };
  }
}
