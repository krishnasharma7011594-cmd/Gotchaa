  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      await profileRepo.updateProfile(
        ...
        ageTier: _selectedDob != null ? _calculateAgeTier(_selectedDob!).index : widget.profile.ageTier,
      ...
      if (finalUsername.isNotEmpty && finalPhoto.isNotEmpty && finalBio.isNotEmpty) {
        ...
        child: Column(
          children: [
            ...
            GestureDetector(
              ...
              child: Stack(
                children: [
                  if (_selectedImageBytes != null) CircleAvatar(
                          radius: 56,
            ...
            _buildSelectionTile(
              label: 'App Language',
              value: _languages.firstWhere((l) => l['code'] == _selectedLanguage, orElse: () => {'name': 'English'})['name']!,
                ...
                showModalBottomSheet(
                  ...
                  builder: (ctx) => Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('Select Language', style: GoogleFonts.outfit(fontSize: 18, fontWeight: FontWeight.bold)),
                        const SizedBox(height: 12),
                        Flexible(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                trailing: _selectedLanguage == lang['code'] ? const Icon(Icons.check_circle, color: AppColors.electricBlue) : null,
                                onTap: () {
        ...
        child: Row(
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(label, style: GoogleFonts.outfit(fontSize: 12, color: Colors.grey.shade500, fontWeight: FontWeight.w500)),
