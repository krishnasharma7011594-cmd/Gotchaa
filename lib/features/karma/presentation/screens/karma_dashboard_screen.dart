...
class KarmaDashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SecureScreen(
      ...
      appBar: AppBar(
        title: Text(context.tr('karma_aura_name'), style: GoogleFonts.outfit(color: Colors.white, fontWeight: FontWeight.bold)),
        backgroundColor: Colors.transparent,
        iconTheme: const IconThemeData(color: Colors.white),
      ),
      body: profileAsync.when(
        data: (profile) {
          if (profile == null) return Center(child: Text(context.tr('error_something_wrong'), style: const TextStyle(color: Colors.white)));
              ...
              children: [
                ...
                Center(
                  child: Stack(
                    ...
                    children: [
                      _buildAuraCircle(180, AppColors.electricBlue.withOpacity(0.3), 5.seconds),
                      _buildAuraCircle(140, AppColors.auraGradient.colors[0].withOpacity(0.4), 3.seconds),
                      Container(
                        width: 120,
                        height: 120,
                            ...
                            children: [
                              if (isUnverified)
                                ImageFiltered(
                                  ...
                                  child: Text('${profile.karma}', style: GoogleFonts.outfit(color: Colors.white, fontSize: 32, fontWeight: FontWeight.bold)),
                                )
                              else
                                Text('${profile.karma}', style: GoogleFonts.outfit(color: Colors.white, fontSize: 32, fontWeight: FontWeight.bold)),
                              Text(context.tr('karma_label'), style: GoogleFonts.outfit(color: Colors.white70, fontSize: 14)),
                              if (isUnverified)
                ...
                _buildInfoCard(context.tr('karma_aura_title'), context.tr('karma_aura_desc')),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: isUnverified ? AppColors.electricBlue.withOpacity(0.3) : AppColors.electricBlue,
  ...
  Widget _buildAuraCircle(double size, Color color, Duration duration) => Container(
      width: size,
      height: size,
     ...
     .scale(begin: const Offset(1, 1), end: const Offset(1.1, 1.1), duration: Duration(milliseconds: duration.inMilliseconds ~/ 2), curve: Curves.easeInOut);
  ...
  Widget _buildInfoCard(String title, String desc) => Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(desc, style: GoogleFonts.outfit(color: Colors.white60, fontSize: 14)),
        ],
      ),
    );
  ...
  Widget _buildTaskItem(String title, String points, bool isDone) => Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(points, style: GoogleFonts.outfit(color: AppColors.auraGradient.colors[1], fontWeight: FontWeight.bold)),
        ],
      ),
    );
