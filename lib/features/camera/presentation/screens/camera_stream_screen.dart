...
class _FrameProcessor {
  ...
  static Future<ui.Image?> process(CameraImage img) async {
    ...
    final planes = img.planes.map((p) => Uint8List.fromList(p.bytes)).toList();
...
const _filterLabel = {
  CameraFilter.normal: 'Normal',
  CameraFilter.noir: 'Noir',
  CameraFilter.golden: 'Golden',
  CameraFilter.arctic: 'Arctic',
  CameraFilter.vivid: 'Vivid',
  CameraFilter.faded: 'Faded',
  CameraFilter.warm: 'Warm',
  CameraFilter.cool: 'Cool',
  CameraFilter.retro: 'Retro',
  CameraFilter.drama: 'Drama',
  CameraFilter.pastel: 'Pastel',
  CameraFilter.neon: 'Neon',
...
const _filterEmoji = {
  ...
  CameraFilter.noir: '⬛',
  CameraFilter.golden: '🌅',
  CameraFilter.arctic: '❄️',
  CameraFilter.vivid: '🌈',
  CameraFilter.faded: '🌫️',
  CameraFilter.warm: '🔥',
  CameraFilter.cool: '🫐',
  CameraFilter.retro: '📼',
  CameraFilter.drama: '🎭',
...
class _LivePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final int effectiveOrientation =
    ...
    final drawW =
        (effectiveOrientation == 90 || effectiveOrientation == 270) ? ih : iw;
    final drawH =
        (effectiveOrientation == 90 || effectiveOrientation == 270) ? iw : ih;
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (_) => PostDetailsScreen(
              ...
              isVideo:
                  media.path.endsWith('.mp4') || media.path.endsWith('.mov'),
            ),
          ),
        );
      }
