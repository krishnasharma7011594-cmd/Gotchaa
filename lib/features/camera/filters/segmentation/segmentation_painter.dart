...
class SegmentationFilterPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (activeBackgroundFilter.id == 'bg_blur') {
      ...
      canvas.drawImageRect(
        cameraFrame, 
        Rect.fromLTWH(0, 0, cameraFrame.width.toDouble(), cameraFrame.height.toDouble()), 
        Rect.fromLTWH(0, 0, size.width, size.height), 
        Paint()..imageFilter = ui.ImageFilter.blur(sigmaX: 10 * intensity, sigmaY: 10 * intensity)
      );
    } 
      ...
      canvas.drawImageRect(
        replacementBgImage!,
        Rect.fromLTWH(0, 0, replacementBgImage!.width.toDouble(), replacementBgImage!.height.toDouble()),
        Rect.fromLTWH(0, 0, size.width, size.height),
        Paint()
      );
    }
  ...
  @override
  bool shouldRepaint(covariant SegmentationFilterPainter oldDelegate) => oldDelegate.cameraFrame != cameraFrame || oldDelegate.intensity != intensity;
}
