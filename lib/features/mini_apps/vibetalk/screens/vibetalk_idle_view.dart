      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.flash_on_rounded, size: 48, color: AppColors.electricBlue),
            ),
        ...
        actions: [
          TextButton(
            ...
            child: Text(context.tr('vibetalk_maybe_later'), style: GoogleFonts.outfit(color: context.textSecondary)),
          ),
          ElevatedButton(
            onPressed: () {
              Navigator.pop(ctx);
            ...
            child: Text(context.tr('vibetalk_unlock_now'), style: GoogleFonts.outfit(fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
            ...
            child: Column(
              ...
              children: [
                ...
                _buildRuleItem(
                  ...
                  title: 'Be Respectful',
                  desc: 'Treat everyone with kindness. Harassment, hate speech, or abuse will get you banned.',
                ),
                const SizedBox(height: 16),
                _buildRuleItem(
                  isDark,
                  ...
                  desc: 'Nudity, vulgarity, or sexually suggestive interactions are strictly prohibited.',
                ),
                const SizedBox(height: 16),
                _buildRuleItem(
                  isDark,
                  ...
                  desc: 'Do not share phone numbers, social handles, or sensitive personal data.',
                ),
                const SizedBox(height: 24),
                    ...
                    Expanded(
                      child: OutlinedButton(
                        ...
                        style: OutlinedButton.styleFrom(
                          foregroundColor: isDark ? Colors.white70 : Colors.black.withOpacity(0.7),
                          side: BorderSide(
                            color: isDark ? Colors.white24 : Colors.black12,
                          ),
                          shape: RoundedRectangleBorder(
          ...
          child: Column(
            ...
            children: [
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () async {
                        ...
                        if (profile != null && !profile.isVerified && state.matchCount >= 5) {
                          _showUpgradePrompt(context);
                          return;
                        }

                        // Mandatory Pre-match Safety Checklist
                        final agreed = await _showPreMatchSafetyChecklist(context);
                        if (!agreed) return;
                        
                        final micGranted = await PermissionManager.requestMicrophonePermission(context);
                        if (micGranted) {
                          await ref.read(vibeTalkProvider.notifier).startMatching(isVideo: false);
                        }
                      },
                      child: Container(
                        height: 64,
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        ...
                        if (micGranted) {
                          ...
                          if (camGranted) {
                            await ref.read(vibeTalkProvider.notifier).startMatching(isVideo: true);
                          }
                        }
                      },
                      child: Container(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.security_rounded, size: 14, color: context.textHint),
