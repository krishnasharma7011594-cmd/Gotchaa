...
class VibeTalkMatchingView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<VibeTalkMatchingView> createState() => _VibeTalkMatchingViewState();
}

class _VibeTalkMatchingViewState extends ConsumerState<VibeTalkMatchingView> with SingleTickerProviderStateMixin {
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  colors: [context.accent, context.accent.withValues(alpha: 0.5)],
              ...
              child: const Icon(Icons.people_alt_rounded, color: Colors.white, size: 50),
            ),
          ),
