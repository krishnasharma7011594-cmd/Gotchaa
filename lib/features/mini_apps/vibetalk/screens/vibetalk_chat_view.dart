...
class _VibeTalkChatViewState extends ConsumerState<VibeTalkChatView> {
  ...
  void _emergencyExit() {
    ref.read(vibeTalkProvider.notifier).endChat();
    EmergencySafetyService.instance
        .sendSilentSos(context: 'vibetalk_emergency_exit');
  ...
  Widget build(BuildContext context) {
    ...
    return ShakeReportListener(
      ...
      onShake: () {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('Emergency report sent. Help is on the way.')),
        );
      },
      child: Column(
        children: [
                ...
                children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          _AudioVisualizer(
                            label: 'You',
                            stream: ref
                                .read(vibeWebRTCServiceProvider)
                          ...
                          _AudioVisualizer(
                            ...
                            isMuted:
                                false, // Partner's mute state is handled by their stream
                  ...
                  Row(
                    children: [
                      ...
                      // Game Menu Button
                      IconButton(
                        onPressed: state.partnerDisconnected
                            ? null
                            : () {
                      ...
                      CircleAvatar(
                        ...
                        child: IconButton(
                          ...
                          onPressed:
                              state.partnerDisconnected ? null : _sendMessage,
                        ),
                      ),
                    ],
                  ),
            ...
            builder: (context, snapshot) {
              ...
              return Row(
                ...
                children: List.generate(5, (index) {
                  final height =
                      4.0 + (level * 30.0 * (1.0 - (index - 2).abs() / 3.0));
                  return Container(
