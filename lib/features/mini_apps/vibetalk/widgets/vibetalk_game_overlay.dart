...
class VibeTalkGameOverlay extends ConsumerWidget {
        ...
        child: TweenAnimationBuilder<double>(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: context.accent.withValues(alpha: 0.3), width: 1),
              boxShadow: [
                BoxShadow(
  ...
  Widget _buildGameInteractions(BuildContext context, WidgetRef ref,
      VibeTalkState state, VibeGameContext game) {
    ...
    if (game.type == 'this_or_that') {
          ...
          children: game.userAnswers.entries.map((e) {
            ...
            return Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                    color: isMe ? context.accent : context.textSecondary),
              ),
            );
          }).toList()
            ..add(Padding(
              ...
              child: ElevatedButton(
                style:
                    ElevatedButton.styleFrom(backgroundColor: context.divider),
                onPressed: () {
                  // Next game
      ...
      if (hasAnswered) {
        return Center(
            child: Text('Waiting for stranger...',
                style: TextStyle(
            ...
            children: [
              Expanded(
                child: ElevatedButton(
                  ...
                  onPressed: () => ref
                      ...
                      .submitGameAnswer(game.optionA ?? 'A'),
                  child: Text(
              ...
              Expanded(
                child: ElevatedButton(
                  ...
                  onPressed: () => ref
                      .read(vibeTalkProvider.notifier)
                      .submitGameAnswer(game.optionB ?? 'B'),
                  child: Text(
    ...
    if (game.type == 'icebreaker' ||
        game.type.startsWith('voice_') ||
        game.type == 'tongue_twister' ||
      ...
      return Wrap(spacing: 12, children: [
        ...
        ElevatedButton(
          ...
          onPressed: () =>
              ref.read(vibeTalkProvider.notifier).startGame(game.type),
          child:
              const Text('Next Prompt', style: TextStyle(color: Colors.white)),
        ),
      ]);
    }
    ...
    if (game.type == 'emoji_guess') {
      if (hasAnswered || bothAnswered) {
        return Text('Answer: ${game.answer}',
      ...
      return ElevatedButton(
        ...
        onPressed: () =>
            ref.read(vibeTalkProvider.notifier).submitGameAnswer('revealed'),
        child:
            const Text('Reveal Answer', style: TextStyle(color: Colors.white)),
      );
    }
