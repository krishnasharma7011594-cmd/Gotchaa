      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            children: VibeTalkGameService.availableGameTypes
                .asMap()
                .entries
                .map((entry) {
...
Widget _buildGameOption(BuildContext context, WidgetRef ref, String type) =>
    Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: context.accent.withValues(alpha: 0.2), width: 1.5),
            borderRadius: BorderRadius.circular(16),
          ),
          child: Text(
