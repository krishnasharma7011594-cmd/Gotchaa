...
class CirclesOnboardingScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CirclesOnboardingScreen> createState() =>
      _CirclesOnboardingScreenState();
}

class _CirclesOnboardingScreenState
    extends ConsumerState<CirclesOnboardingScreen> {
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        ref
                            .read(circlesOnboardingProvider.notifier)
                            .skipOnboarding();
                      },
                      child: Text(
                        'Skip',
