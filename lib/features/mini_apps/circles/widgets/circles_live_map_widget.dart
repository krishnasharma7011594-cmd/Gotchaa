...
class _CirclesLiveMapWidgetState extends State<CirclesLiveMapWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final centerLatLng = hasLatLng
        ? ll.LatLng(widget.circle.locationLatLng!.latitude,
            widget.circle.locationLatLng!.longitude)
        : const ll.LatLng(28.6139, 77.2090); // Default to Delhi coords if none

    return StreamBuilder<List<Map<String, dynamic>>>(
      stream: CirclesLiveLocationService.instance
          .listenToLiveLocations(widget.circleId),
