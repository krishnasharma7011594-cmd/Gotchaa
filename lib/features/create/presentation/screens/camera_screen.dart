...
class _CameraScreenState extends State<CameraScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _takePicture() async {
    ...
    try {
      ...
      final isFront = _cameras != null && _cameras!.isNotEmpty && _cameras![_selectedCameraIndex].lensDirection == CameraLensDirection.front;
      _navigateToPreview(File(file.path), isVideo: false, isFrontCamera: isFront);
    } catch (e) {
  ...
  Future<void> _stopRecording() async {
    ...
    try {
      ...
      final isFront = _cameras != null && _cameras!.isNotEmpty && _cameras![_selectedCameraIndex].lensDirection == CameraLensDirection.front;
      _navigateToPreview(File(file.path), isVideo: true, isFrontCamera: isFront);
    } catch (e) {
  ...
  InputImage _convertCameraImage(CameraImage image) {
    ...
    final InputImageMetadata metadata = InputImageMetadata(
      ...
      rotation: InputImageRotation.rotation90deg, // Adjust based on platform/orientation
  ...
  void _navigateToPreview(File file, {required bool isVideo, bool isFrontCamera = false}) {
    Navigator.push(
      context,
      MaterialPageRoute(
      ...
      body: ListenableBuilder(
        ...
        builder: (context, _) => Stack(
            ...
            children: [
              ...
              if (_filterManager.activeViral != null || _filterManager.globalIntensity > 0)
                AROverlaysWidget(
                  filter: _filterManager.activeViral ?? _filterManager.allFilters.first, // Default or none
                  intensity: _filterManager.globalIntensity,
                  face: _detectedFace,
                            ...
                            GestureDetector(
                              ...
                              child: AnimatedBuilder(
                                ...
                                builder: (context, child) {
                                  final scale = 1.0 + (_recordAnimationController.value * 0.3);
