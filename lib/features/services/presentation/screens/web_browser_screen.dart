...
class GotchaaWebBrowserScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<GotchaaWebBrowserScreen> createState() =>
      _GotchaaWebBrowserScreenState();
}

class _GotchaaWebBrowserScreenState
    extends ConsumerState<GotchaaWebBrowserScreen> {
  ...
  void _showBlinkitNoLocationMessage() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content: const Text(
          'Location needed for delivery — please enable in settings'),
