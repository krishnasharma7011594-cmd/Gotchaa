    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          if (widget.isVideo &&
              rtcState.state == RTCConnectionState.connected &&
              !isCameraOff)
          ...
          SafeArea(
            child: Column(
              children: [
                ...
                if (rtcState.state != RTCConnectionState.connected)
                  _buildUserIdentity(rtcState),
                const Spacer(),
                if (rtcState.state == RTCConnectionState.connected)
                  _buildCallTimer(),
        ...
        CachedNetworkImage(
          ...
          errorWidget: (context, url, error) => CircleAvatar(
            ...
            child: Text(widget.userName[0].toUpperCase(),
                style: GoogleFonts.outfit(fontSize: 40, color: Colors.white)),
          ),
        ...
        child: Column(
          children: [
            Icon(Icons.verified_user_rounded,
                color: rtc.state == RTCConnectionState.connected
                    ? AppColors.electricBlue
                    : Colors.white24,
                size: 24),
            const SizedBox(height: 8),
            Text(
              rtc.state == RTCConnectionState.connected
