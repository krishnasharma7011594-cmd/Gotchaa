...
void main() {
  test('read transcript user messages', () {
    final file = File(r'C:\Users\hp\.gemini\antigravity\brain\a25eaee5-1f98-4089-9e5f-a34b2ba27a12\.system_generated\logs\transcript.jsonl');
    if (!file.existsSync()) {
      ...
      if (line.contains('"type":"USER_INPUT"')) {
        try {
          ...
          if (content.contains('Dangerous Permissions')) {
            print('--- User Message with Dangerous Permissions at index $i ---');
            print(content);
          }
        } catch (e) {
          // ignore
