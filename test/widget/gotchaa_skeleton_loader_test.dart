...
void main() {
  group('GotchaaSkeletonLoader Tests', () {
    testWidgets('Feed skeleton renders with shimmer', (WidgetTester tester) async {
    ...
    testWidgets('Chat list skeleton renders with shimmer', (WidgetTester tester) async {
    ...
    testWidgets('Profile skeleton renders with shimmer', (WidgetTester tester) async {
    ...
    testWidgets('Card skeleton renders with shimmer', (WidgetTester tester) async {
