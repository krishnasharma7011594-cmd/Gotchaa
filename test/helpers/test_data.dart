...
final testPost2 = PostModel(
    ...
    uid: 'user_mx',
    createdAt: DateTime.now(),
    caption: 'Post 2 from Mexico',
    likesCount: 20,
    commentsCount: 10);
final testPost3 = PostModel(
    postId: 'post_3',
    uid: 'user_uae',
    createdAt: DateTime.now(),
    caption: 'Post 3 from UAE',
    likesCount: 30,
    commentsCount: 15);
...
GotchaaService getMockService(
    {required String id,
    required String name,
    String url = '',
    ServiceCategory category = ServiceCategory.food,
